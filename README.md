...
+ Code must adhere to our [coding style](https://github.com/openware/gocryptotrader/blob/master/.github/CONTRIBUTING.md).
...
cp config_example.json ~/.irix/config.json
```
